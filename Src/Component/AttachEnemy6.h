#pragma once
#ifndef ATTACHENEMY6_H_INCLUDE
#define ATTACHENEMY6_H_INCLUDE
#include "../Component.h"
...
public:
	...
	AttachEnemy6(GameObjectPtr gameObject)noexcept
		:Component(gameObject) {
		name = "AttachEnemy6";
	}
	virtual ~AttachEnemy6() = default;
	...
	virtual void Start()override
	{
		//基本処理
		{
			...
			bullet->move.moveVector = vec3(vx, vy, 0);
		}

		auto tcList = CharacterTCList<Enemy6>();
